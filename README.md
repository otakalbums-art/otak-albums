...
1. **Завантаження фото фотографом** — найімовірніше, десктопний загрузчик
   (папка на комп'ютері фотографа → автосинхронізація в Supabase Storage +
   вставка рядків у `photos`) або веб-форма в адмінці з drag&drop і
   автовизначенням категорії за назвою підпапки.
